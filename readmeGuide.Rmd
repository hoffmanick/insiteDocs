...
And you would write a README with the following name:
...
These metadata values <b>must</b> be findable in your README file. The definitions of these metadata fields can be found on the relevant NCBI page. For the min info about a gene marker sequence for a host-associated specimen, that would be <a href="https://ncbi.nlm.nih.gov/biosample/docs/packages/MIMARKS.specimen.host-associated.6.0/" target="_blank">here</a>.
