...
Making code easy to understand increases the reusability of that code, which has an incremental effect in generally accelerating the pace of scientific discovery. Also, making code easy to understand provides a benefit to your future self. You may forget in the future tacit knowledge about the operation of your code which you once held. It therefore behooves you to make your coding practice as transparent, explicit, and meaningful as you can.
...
1. You chan choose to start your script with an annotated description of the what the code does, as well as who authored it. Or else, you can put this information in a manifest, which is basically a metadata file for computational scripts. In a big organization like INSITE, scripts may outlive people, and it's important to properly attribute work, as well as to know who to reach out to in case questions arise.
